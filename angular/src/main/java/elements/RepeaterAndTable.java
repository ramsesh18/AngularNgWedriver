...
import elementIdenfier.FindElementIdentifierUsingNgRepeat;
...
public class RepeaterAndTable extends GlobalInitializer {
	
	FindElementIdentifierUsingNgRepeat findelementidentifierusingngrepeat;
	
	public RepeaterAndTable(WebDriver driver){
	...
	/**
	 * This method navigates to the element using rowId and column name and would 
	 * retrieve the value
	 * @param repeatIdentifier
	 * @param rowId
	 * @param columnName
	 ...
	 * 
	 */
	public void selectValuesBasedOnRowIdAndColumnNameAndClickIt(String repeatIdentifier, int rowId,String columnName){
		 findelementidentifierusingngrepeat.getTheListValueOfNgRepeatBasedOnRowNumberAndColumnName(repeatIdentifier,rowId,columnName)
				.click();
